...
function start() {
    cm.sendSimple("你听说过海滩吗？ #b“佛罗里娜”海滩#k, 位于利思港附近？ 我现在可以带你去那里，只要支付 #b1500 金币#k就行啦, 如果你有 #b海滩的VIP门票#k那你就是尊贵的客人，我将免费送你去哦.\r\n\r\n#L0##b 支付1500金币.#l\r\n#L1# 我有VIP门票。#l\r\n#L2# VIP门票是什么？#k?#l");
}
...
function action(mode, type, selection) {
    ...
    if(status == 1){
        if(selection == 1)
            cm.sendYesNo("有#b“佛罗里娜”海滩的VIP门票#k? 你可以随时带着它去“佛罗里娜”海滩。注意：你可能会在那里遇到一些怪物。好的，你现在想去“佛罗里娜”海滩吗？");
        else if (selection == 2)
            cm.sendNext("你居然有 #b“佛罗里娜”海滩的VIP门票！#k 不可思议！！只要您拥有，您就可以免费前往弗洛里娜海滩。这是一件非常罕见的物品，甚至我们都不得不购买，但不幸的是，几周前，我在暑假期间丢失了它。");
    } else if (status == 2){
        if(type != 1 && selection != 0) {
            ...
            if (cm.getMeso() < 1500 && selection == 0)
                ...
                cm.sendNext("口袋里似乎没有#b“佛罗里娜”海滩的VIP门票。\r\n#k 再去找找，风里雨里，我始终在这等你。");
            }else{
                if(selection == 0)
                    cm.gainMeso(-1500);
