...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (sel == 0) {
            ...
            cm.sendNext("关于拾取物品的方法：击败怪物后战利品会掉落，这时候站在物品前按#b Z键#k或#b数字0 键#k，就可以拣取物品。");
        } else if (sel == 3) {
            ...
            if (sel == 0) {
                ...
                cm.sendNextPrev("将鼠标光标放在所有能力点的上面，可以查看简要说明。例如，力量是战士、拳手的主属性，敏捷是弓箭手、火枪手的主属性，智力是魔法师的主属性，运气则是飞侠的主属性。你需要仔细地思考如何通过分配能力点（AP）来发挥角色的优势。");
            } else if (sel == 15) {
